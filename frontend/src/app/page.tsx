...
export default function HomePage() {
  ...
  // Switch language and select first available voice for that language
  ...
  return (
    <div className="w-full space-y-8 sm:space-y-10 opacity-100 transition-opacity duration-200">
      ...
      {/* Screen reader & SEO crawler hidden secondary heading */}
      ...
      <section className="text-center space-y-3">
        <div className="inline-flex flex-wrap items-center justify-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-200 shadow-sm">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight">
          ...
          <span className="text-blue-600">in Hindi & 10+ Indian Languages</span>
        </h1>

        <p className="text-xs sm:text-base text-slate-600 max-w-xl mx-auto leading-relaxed">
          Convert text to realistic human AI voice instantly. Supports pure Hindi, Marathi, Bengali, Tamil, Telugu, Gujarati, Kannada, Malayalam, Punjabi & English.
        </p>
      </section>

      {/* Main Form Card Container */}
      <section className="bg-white rounded-2xl p-4 sm:p-8 border border-slate-200 shadow-sm space-y-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full p-3.5 sm:p-4 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white transition resize-y disabled:opacity-50"
            />
          </div>

          {/* Dynamic UI Helper Hint Below Textarea */}
          <div className="flex items-start gap-2 p-3 bg-blue-50/70 border border-blue-100 rounded-xl text-xs text-slate-600">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Generate unlimited audio without creating an account or providing email address. Fast and instant.
          </p>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Download generated audio MP3 files instantly for videos, study material, presentations, and personal use.
          </p>
        </div>
      </section>
    </div>
